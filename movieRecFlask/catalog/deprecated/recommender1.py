...
def recommender_final(movie_name):
    ...
    # make a list of movie_indexes of the movie_name
    ...
    # similar_movies is unsorted list of the indexes[0] and their cosine scores[1] inside the movies_with_tags table
