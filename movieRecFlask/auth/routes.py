...
def do_the_login():
    ...
    # and we skip all this and go to the last return, displaying the login.html
    form = LoginForm()
    ...
    if form.validate_on_submit():
        ...
        # 'if not user' --> means if the 'user' does not exist in our database or
        ...
        # if user log in IS valid, display the books!
